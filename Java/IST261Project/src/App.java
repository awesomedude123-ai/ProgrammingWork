...
public class App {
    public static void main(String[] args) {
         ...
         */
                  ...
                  UserListController userListController = new UserListController(model, listView);
                  System.out.println("I am serializing the Skill and Expert User class. The persistence controlelrs are SkillPersistenceController and ExpertUserPersistenceController respectively");
