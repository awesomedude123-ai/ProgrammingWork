...
class ExpertUserController{
    ...
    public ArrayList<ExpertUser> users;
    ...
    public ExpertUserController(UserController userController, UserListController userListController){
        ...
        if(userController.getUsers().size()>0){
            for(User user: userController.getUsers()){
                if(user.getType()==Type.EXPERT){
                    this.users.add((ExpertUser)user);
                }
                ...
                if(!isThere){
                    ...
                    if(company.isEmpty()){
                        ...
                        if(this.view.form.getYearsOfExperienceValue().getSelectedItem()==null){
                            ...
                            this.userListController.users = this.userController.getUsers();
        ...
        this.view.form.getQuitButton().addActionListener(x -> {
            ...
            this.userListController.expertUserPersistenceController.setExperts(userList);
            this.userListController.expertUserPersistenceController.writeExpertsFile();
            System.exit(1);
        });//end quit button
...
class StudentUserController{
    ...
    public StudentUserController(UserController userController, UserListController userListController){
        ...
        this.recommendationTableController = new RecommendationTableController(new RecommendationListView(), new RecommendationTableModel());
