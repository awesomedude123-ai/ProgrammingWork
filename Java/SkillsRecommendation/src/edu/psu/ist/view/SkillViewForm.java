...
public class SkillViewForm {
    ...
    public JLabel getExpertNameLabel() {
        return expertNameLabel;
    }

    public void setExpertNameLabel(JLabel expertNameLabel) {
        this.expertNameLabel = expertNameLabel;
    }
    ...
    public void setUIDesign() {
        ...
        this.getExpertNameLabel().setFont(new Font("Times New Roman",Font.ITALIC,14));
        this.getExpertNameLabel().setForeground(Color.CYAN);
