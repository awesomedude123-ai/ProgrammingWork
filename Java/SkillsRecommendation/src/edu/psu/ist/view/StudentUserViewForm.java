...
public class StudentUserViewForm {
    ...
    public void setUIDesign(){
        ...
        this.getSchoolNameValue().setFont(new Font("Times New Roman", Font.ITALIC,14));
        this.getYearComboBox().setFont(new Font("Times New Roman", Font.ITALIC, 14));
        this.getSchoolTypeComboBox().setFont(new Font("Times New Roman", Font.ITALIC,14));
