...
public class PartC_2152_901 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 3; i++) {
			...
			System.out.println("#   # # #   #   : " + a2[1][1] + a2[1][0]);
			System.out.println("#           #   : " + a2[2][1] + a2[2][0]);
			System.out.println("# # # # # # #   : " + a2[3][1] + a2[3][0]);
			System.out.println("                : " + a1[0][1] + a1[0][0]);
			System.out.println("# : : : : : : : : " + a1[1][1] + a1[1][0]);
