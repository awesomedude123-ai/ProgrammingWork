...
df_fraud= pd.read_csv('/Users/awesomedude123/Desktop/Programming/Python/payment_fraud.csv')
...
df_fraud.mean(numeric_only=True)
...
print("here")
d=df_fraud[(df_fraud.label==1) & (df_fraud['paymentMethod']=='paypal')] [0:4]
print(d)
