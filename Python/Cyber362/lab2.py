...
data = pd.read_csv('/Users/awesomedude123/Desktop/Programming/Python/brain_size.csv', sep=';', na_values=".")
...
print((groupby_gender.mean()['MRI_Count']['Female']+groupby_gender.mean()['MRI_Count']['Male'])/2)
